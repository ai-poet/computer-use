...
def _registration_block(*, enabled: bool, provider: str | None) -> str:
    if enabled:
        return (
            ...
            "- registration.email.tool:`python backend/scripts/email_otp.py`\n"
            "- credential.store:`python backend/scripts/email_otp.py cred-put/cred-get/cred-list`"
    ...
    return (
        ...
        "- credential.store:`python backend/scripts/email_otp.py cred-get/cred-list`"
