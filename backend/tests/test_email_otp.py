#!/usr/bin/env python3
"""Unit tests for analysis.email_otp (no network)."""
...
from analysis import email_otp  # noqa: E402
from settings import credentials as cred_store  # noqa: E402
from core.tasks import write_metadata_seed  # noqa: E402
from analysis.workflow import load_workflow, redact_text, seed_workflow  # noqa: E402
