#!/usr/bin/env python3
"""Smoke test for backend/src/sandbox/sandbox_ctl.py (local Docker + Firefox).
...
_CTL = _REPO_ROOT / "backend" / "scripts" / "sandbox_ctl.py"
...
def _run_ctl(args: list[str], *, env: dict | None = None) -> subprocess.CompletedProcess[str]:
    ...
    from sandbox.sandbox_runtime import (  # noqa: E402
